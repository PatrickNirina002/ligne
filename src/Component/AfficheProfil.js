...
export default class AfficheProfil extends Component {
  ...
  componentDidMount() {
    axios.get('http://pasybemety.herokuapp.com' + this.props.location.pathname)
      .then(response => {
            ...
            <table className="table">
              ...
              <tbody>
                <tr>
                  ...
                  <td><img  alt="pdp" width="50px" height="50px" src={'http://pasybemety.herokuapp.com/user/'+this.state.photo}/></td>
                </tr>
              </tbody>
            </table>
          </div>
